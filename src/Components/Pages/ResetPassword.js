...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    if (pass === confirmPass) {
      ...
      await fetch(
        "https://team.flymingotech.in/azamDeals/public/api/forgotPassword",
        requestOptions
      )
      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gray-100 h-screen md:h-auto lg:h-auto w-screen flex rounded-2xl shadow-lg max-w-3xl items-center p-5 md:p-0 lg:p-0">
          ...
          <div className="w-full md:w-1/2 px-8 md:px-12">
            ...
            <p className="text-xs text-[#002D74] capitalize">
            ...
            <form action="" className="flex flex-col gap-4 mt-10">
              <div className="relative mt-20 md:mt-0 lg:mt-0">
                <label
                  htmlFor=""
                  className="capitalize text-sm md:text-xs lg:text-xs font-bold text-[#002D74] mb-4 ml-1"
                >
                  Password:
                </label>
                <input
            ...
            <div className="mt-72 md:mt-20 lg:mt-20 text-xs flex justify-between items-center text-[#002D74]">
