...
const ShippingDetails = (props) => {
  ...
  const getAllAddress = async () => {
    ...
    await fetch(
      `https://team.flymingotech.in/azamDeals/public/api/addressByCustomerId/${localStorage.getItem(
        "customer_id"
      )}`,
      requestOptions
    )
  ...
  const handleDeleteAddress = async (id) => {
    ...
    await fetch(
      `https://team.flymingotech.in/azamDeals/public/api/deleteAddress/${id}`,
      requestOptions
    )
      .then((response) => response.json())
