...
const RecentOrders = (props) => {
  ...
  const GetOrderHistory = async () => {
    ...
    await fetch(
      `https://team.flymingotech.in/azamDeals/public/api/DetailByCustomerId/${localStorage.getItem(
        "customer_id"
      )}`,
      requestOptions
    )
                ...
                >
                  <div className="flex">
                    ...
                    <div className="ml-2 w-2/3">
                      ...
                      <div className="flex items-end font-medium underline text-md text-emerald-500">
