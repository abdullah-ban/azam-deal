...
const UpdateProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    if (name === "") {
      ...
      await fetch(
        `https://team.flymingotech.in/azamDeals/public/api/UpdateProfile/${localStorage.getItem(
          "customer_id"
        )}`,
        requestOptions
      )
                      ...
                      <div className="lg:mt-6 mt-4 bg-white">
                        <div className="grid grid-cols-6 gap-6">
                          <div className="col-span-6 sm:col-span-3">
                            <InputArea
                              ...
                              value={
                                (getCustomerData && getCustomerData["name"]) ||
                                ""
                              }
                        ...
                        <div className="w-full mt-2">
                          <InputArea
                            ...
                            className="w-full"
                            value={
                              (getCustomerData && getCustomerData["email"]) ||
                              ""
                            }
